...
dados_do_banco_opcoes = cursor.fetchall()
...
caixa_confirmadora_bgm = ExibirImagemInterativa('modulos/setores/b_inicio/opcoes_ext/caixa_marcada.png', 'modulos/setores/b_inicio/opcoes_ext/caixa_nao_marcada.png', 35, 35, 11.3, 71.6)#, dados_do_banco_opcoes[0][1])
...
caixa_confirmadora_sfx = ExibirImagemInterativa('modulos/setores/b_inicio/opcoes_ext/caixa_marcada.png', 'modulos/setores/b_inicio/opcoes_ext/caixa_nao_marcada.png', 35, 35, 11.3, 75.9)#, dados_do_banco_opcoes[0][3])
...
caixa_confirmadora_efeitos = ExibirImagemInterativa('modulos/setores/b_inicio/opcoes_ext/caixa_marcada.png', 'modulos/setores/b_inicio/opcoes_ext/caixa_nao_marcada.png', 35, 35, 11.3, 81.8)#, dados_do_banco_opcoes[0][5])
